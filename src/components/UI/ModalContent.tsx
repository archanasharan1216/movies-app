...
const inputHandler = (event: React.ChangeEvent<HTMLInputElement>, setFunction: React.Dispatch<React.SetStateAction<typeof event.target.value>>) => {
...
const isDate = (date: string | number | Date): boolean => (new Date(date).toString() !== "Invalid Date") && !isNaN(Number(new Date(date)))
...
const ModalContent:React.FunctionComponent<IModalContent> = (props) => {
    ...
    const validateForm = useCallback(() => {
        ...
        const ratingHasError = !(0 <= Number(rating || 0) && Number(rating || 0) <= 100);
        const runtimeHasError = !(0 < Number(runtime || 0) && Number(runtime || 0) <= 360);
        ...
        return {
            hasError: titleHasError && movieUrlHasError && ratingHasError && runtimeHasError && releaseDateHasError,
        ...
        <Form onSubmit={handleSubmit} onReset={handleFormReset}>       
           <div className='modalTitle'>
            ...
            <div className='rowWrapper'>
                <div className='textInput firstColumn'>
                    <TextInput
                        ...
                        placeholder='Title'
                        value={title} />
                    {validateForm().titleHasError[0] && isSubmitted && <InputErrorMessage>{
            ...
            <div className='rowWrapper'>
                <div className='textInput firstColumn'>
                    <TextInput
                        ...
                        placeholder='https://'
                        value={movieUrl} />
                    {validateForm().movieUrlHasError[0] && isSubmitted && <InputErrorMessage>{
                ...
                <div className='textInput secondColumn'>
                    <TextInput
                            ...
                            placeholder='7.8'
                            value={rating} />
                    {validateForm().ratingHasError[0] && isSubmitted && <InputErrorMessage>{
            ...
            <div className='rowWrapper'>
                ...
                {validateForm().genreHasError[0] && isSubmitted && <InputErrorMessage>{
                ...
                <div className='textInput secondColumn'>
                    <TextInput
                            ...
                            placeholder='minutes'
                            value={runtime} />
                    {validateForm().runtimeHasError[0] && isSubmitted && <InputErrorMessage>{
            ...
            <div className='submitSection'>
                <Button buttonClass='resetButton buttonClass' name='RESET' type='reset'> </Button>
                <Button buttonClass='submitButton buttonClass' name='SUBMIT' type='submit'> </Button>
            </div>
        </Form>
